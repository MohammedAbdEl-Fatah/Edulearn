...
import { SignUpStudentDTO, SignUpTeacherDTO } from "./auth.dto";
...
class AuthenticationService {
    ...
    private sendMailler = async (user: IUser) => {
        ...
        await sendEmail({
            ...
            text: "Verify Email",
            html: verifyEmailTemplate(user.email, user.otp, remendOtpExpire)
        });
    }
